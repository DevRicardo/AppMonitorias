...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $monitore->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Monitores", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/monitores/'.$monitore->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Monitores", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.monitores.destroy', $monitore->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/monitores') }}" data-toggle="tooltip" data-placement="right" title="Back to Monitores"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'tipo_doc')
						@la_display($module, 'numero_doc')
						@la_display($module, 'nombre_monitor')
						@la_display($module, 'apellido_monitor')
						@la_display($module, 'email_monitor')
						@la_display($module, 'facultad_id')
						@la_display($module, 'programa_id')
						@la_display($module, 'promedio_credito')
					</div>
				</div>
			</div>
		</div>
